...
<div id="tabla_tono" class="table-responsive col-md-12">
	...
	<div style="text-align: center;">
	  ...
	  <a type="button" id="btn_hazmat" class="btn btn-success tono2 btn-lg">(10-6/10-1)</a>
	  <a type="button" id="btn_otros" class="btn btn-success tono2 btn-lg">OTROS(10-7/10-2/10-8)</a>
	</div>
	<br>
	<br>
	<div style="text-align: center;">
